...
export const ORCHESTRATION = {
  TOPIC: {
    REPORT: {
      ...
      GET_SUMMARY_PER_BRGY: "reportKycGetSummaryPerBrgy",
      GET_SUMMARY_PER_AGE: "reportKycGetSummaryPerAge",
      GET_SUMMARY_PER_AGE_BRACKET: "reportKycGetSummaryPerAgeBracket",
      GET_SUMMARY_PER_EMPLOYMENT_STATUS: "reportKycGetSummaryPerEmploymentStatus",
      GET_SUMMARY_SENIORCITIZEN_PER_BRGY: "reportKycGetSummarySeniorCitizenPerBrgy",
    },
  },
  PROCESS_DEFINITION: {
    REPORT: {
